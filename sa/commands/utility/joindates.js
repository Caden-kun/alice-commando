...
class JoindatesCommand extends commando.Command {
    constructor(client) {
        super(client, {
            args: [
                {
    ...
    async run(msg, { joindate }) {
        if (msg.guild === null)
            return msg.reply("This command can only be used in guilds!");
        let member = await getMember_1.getMember(joindate, msg.guild);
...
exports.default = JoindatesCommand;
